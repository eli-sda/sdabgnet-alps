...
export const ArchiveContent = ({
  ...
  return (
    <GridSeven
      className={`l-main__content u-padding--zero--sides u-spacing--double--until-xxlarge l-grid l-grid--7-col l-grid-wrap--6-of-7 u-shift--left--1-col--at-xxlarge${pageClassName ? ` ${pageClassName}` : ''}`}
      id="top"
      as="section"
    >
